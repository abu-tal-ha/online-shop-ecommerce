...
const UploadProduct = ({ onClose, fetchData }) => {
  ...
  const handleAddImageLink = () => {
    ...
    setData((prev) => ({
      ...prev,
      productImage: [...prev.productImage, imageLink.trim()],
    }));
    setImageLink("");
    ...
    <div className="fixed w-full h-full bg-slate-200 bg-opacity-35 top-0 left-0 flex justify-center items-center">
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
        ...
        >
          ...
          {/* ইমেজ লিংক ইনপুট */}
          <label htmlFor="imageLink" className="mt-3">
            Image Link :
          </label>
          ...
          <div>
            {data.productImage.length > 0 ? (
              ...
              <p className="text-red-600 text-xs">*Please add an image link</p>
            )}
          </div>
