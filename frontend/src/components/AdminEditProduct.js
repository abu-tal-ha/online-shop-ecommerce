...
//     if (imageLink) {
//       setData((prev) => ({ ...prev, productImage: [...prev.productImage, imageLink] }));
//       setImageLink("");
//     }
//   };
...
//             />
//             <button type="button" className="px-3 py-2 bg-blue-600 text-white hover:bg-blue-700" onClick={handleAddImageLink}>
//               Add
//             </button>
//           </div>
//           <label htmlFor="uploadImageInput">
